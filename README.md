...
Built with LangChain, OpenAI API, and HuggingFace BGE-m3 embedding

Progress:
- Acquired ByteStrike data and uploaded to document loaders in LangChain
- Embedded documents and stored in persistent ChromaDB
